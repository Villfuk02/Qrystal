...
public class OreGeneration {
    ...
    public static void setupOreGeneration() {
        ...
        QrystalPlacement.PlacementConfig richQawaCfg = new QrystalPlacement.PlacementConfig(QrystalConfig.ore_spawn_tries_rich, 30, 45, "ocean_floor", 2);
        ...
        QrystalPlacement.PlacementConfig richSecondTierCfg = new QrystalPlacement.PlacementConfig(QrystalConfig.ore_spawn_tries_rich, 10, 30, "", 0);
        
        ForgeRegistries.BIOMES.getValues().stream().filter(biome -> biome.getCategory() != Biome.Category.THEEND).filter(biome -> biome.getCategory() != Biome.Category.NETHER).forEach(biome -> {
    ...
    public static void addOre(Biome biome, Block block, int size, QrystalPlacement.PlacementConfig cfg) {
        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, block.getDefaultState(), size))
