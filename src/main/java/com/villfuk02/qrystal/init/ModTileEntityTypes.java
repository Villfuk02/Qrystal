...
public class ModTileEntityTypes {
    ...
    public static final TileEntityType<SteelCutterTileEntity> STEEL_CUTTER = null;
    public static final TileEntityType<DiamondCutterTileEntity> DIAMOND_CUTTER = null;
