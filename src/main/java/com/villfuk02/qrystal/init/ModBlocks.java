...
public class ModBlocks {
    ...
    public static final Block STEEL_CONDENSING_BARREL = new CondensingBarrelBlock("steel", 7, Material.IRON, MaterialColor.STONE, SoundType.STONE);
    public static final Block DIAMOND_CONDENSING_BARREL = new CondensingBarrelBlock("diamond", 8, Material.IRON, MaterialColor.DIAMOND, SoundType.STONE);
    public static final Block EMERALD_CONDENSING_BARREL = new CondensingBarrelBlock("emerald", 9, Material.IRON, MaterialColor.EMERALD, SoundType.STONE);
    public static final Block ENDSTEEL_CONDENSING_BARREL = new CondensingBarrelBlock("endsteel", 10, Material.IRON, MaterialColor.PURPLE, SoundType.STONE);
    public static Map<String, Block> QRYSTAL_BLOCKS = new HashMap<>();
    public static final Block IMBUED_ALLOY_BLOCK = new BlockBase("imbued_alloy_block", Material.IRON, MaterialColor.DIAMOND, SoundType.STONE, 4f, 10f, ToolType.PICKAXE, 0);
